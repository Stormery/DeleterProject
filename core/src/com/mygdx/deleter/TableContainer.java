...
public class TableContainer {
	...
	public static Table tableLeftScrollable;
	public static Table tableBottomScrollable;
	...
	public static void initTables() {
		...
		tableRight.row();
		tableRight.add(MainScreen.buttonTxtStart).height(56f).expandX().padTop(25f).colspan(2);
		tableRight.row();
		tableRight.add(MainScreen.startButton).height(56f).width(96f).padBottom(20f).padTop(20f);
		tableRight.add(MainScreen.buttonReset).height(56f).width(96f).padBottom(20f).padTop(20f);
